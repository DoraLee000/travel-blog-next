...
var cardModule = function cardModule(_ref) {
  ...
  return __jsx(_routes__WEBPACK_IMPORTED_MODULE_5__["Link"], {
    ...
    hoverable: true,
    key: post.id,
    title: post.name // cover={<img alt={ post.name } src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" />}
    ,
    className: "card mb-50"
  }, __jsx("ul", null, __jsx("li", null, pic.src), __jsx("li", null, __jsx("span", {
    className: "content-p"
...
//# sourceMappingURL=index.js.01ae0169d53873ce2596.hot-update.js.map